...
// renderLogger logs widget render timing information.
func renderLogger(name string, durationMs float64) {
	logger.Info("%s %d ms", name, int(durationMs))
}
