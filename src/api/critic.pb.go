...
func (x *CreateCommentRequest) GetOldFile() string {
	if x != nil {
		return x.OldFile
	}
	return ""
...
func (x *CreateCommentRequest) GetOldLine() int32 {
	if x != nil {
		return x.OldLine
	}
	return 0
...
func (x *CreateCommentRequest) GetNewFile() string {
	if x != nil {
		return x.NewFile
	}
	return ""
...
func (x *CreateCommentRequest) GetNewLine() int32 {
	if x != nil {
		return x.NewLine
	}
	return 0
...
func (x *CreateCommentResponse) GetError() *RpcError {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *GetCommentsRequest) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *GetCommentsResponse) GetConversations() []*Conversation {
	if x != nil {
...
func (x *GetCommentsResponse) GetError() *RpcError {
	if x != nil {
		return x.Error
	}
	return nil
...
const file_critic_proto_rawDesc = "" +
	...
	"\x05error\x18\x0f \x01(\v2\x13.critic.v1.RpcErrorR\x05error\"\x9c\x01\n" +
	...
	"\x05error\x18\x0f \x01(\v2\x13.critic.v1.RpcErrorR\x05error\"\x9f\x02\n" +
	...
	"\x11LINE_TYPE_DELETED\x10\x032\xff\x04\n" +
	"\rCriticService\x12R\n" +
	...
	"\aGetFile\x12\x19.critic.v1.GetFileRequest\x1a\x1a.critic.v1.GetFileResponse\x12R\n" +
	"\rCreateComment\x12\x1f.critic.v1.CreateCommentRequest\x1a .critic.v1.CreateCommentResponse\x12L\n" +
	"\vGetComments\x12\x1d.critic.v1.GetCommentsRequest\x1a\x1e.critic.v1.GetCommentsResponse\x12O\n" +
...
var file_critic_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_critic_proto_goTypes = []any{
	...
	(*CreateCommentRequest)(nil),   // 19: critic.v1.CreateCommentRequest
	(*CreateCommentResponse)(nil),  // 20: critic.v1.CreateCommentResponse
	(*GetCommentsRequest)(nil),     // 21: critic.v1.GetCommentsRequest
	(*GetCommentsResponse)(nil),    // 22: critic.v1.GetCommentsResponse
	(*Conversation)(nil),           // 23: critic.v1.Conversation
	(*Message)(nil),                // 24: critic.v1.Message
	(*GetDiffBasesRequest)(nil),    // 25: critic.v1.GetDiffBasesRequest
	(*GetDiffBasesResponse)(nil),   // 26: critic.v1.GetDiffBasesResponse
	(*SetDiffBaseRequest)(nil),     // 27: critic.v1.SetDiffBaseRequest
	(*SetDiffBaseResponse)(nil),    // 28: critic.v1.SetDiffBaseResponse
}
var file_critic_proto_depIdxs = []int32{
	...
	3,  // 15: critic.v1.CreateCommentResponse.error:type_name -> critic.v1.RpcError
	23, // 16: critic.v1.GetCommentsResponse.conversations:type_name -> critic.v1.Conversation
	3,  // 17: critic.v1.GetCommentsResponse.error:type_name -> critic.v1.RpcError
	24, // 18: critic.v1.Conversation.messages:type_name -> critic.v1.Message
	3,  // 19: critic.v1.GetDiffBasesResponse.error:type_name -> critic.v1.RpcError
	3,  // 20: critic.v1.SetDiffBaseResponse.error:type_name -> critic.v1.RpcError
	4,  // 21: critic.v1.CriticService.GetLastChange:input_type -> critic.v1.GetLastChangeRequest
	6,  // 22: critic.v1.CriticService.GetDiffSummary:input_type -> critic.v1.GetDiffSummaryRequest
	8,  // 23: critic.v1.CriticService.GetDiff:input_type -> critic.v1.GetDiffRequest
	17, // 24: critic.v1.CriticService.GetFile:input_type -> critic.v1.GetFileRequest
	19, // 25: critic.v1.CriticService.CreateComment:input_type -> critic.v1.CreateCommentRequest
	21, // 26: critic.v1.CriticService.GetComments:input_type -> critic.v1.GetCommentsRequest
	25, // 27: critic.v1.CriticService.GetDiffBases:input_type -> critic.v1.GetDiffBasesRequest
	27, // 28: critic.v1.CriticService.SetDiffBase:input_type -> critic.v1.SetDiffBaseRequest
	5,  // 29: critic.v1.CriticService.GetLastChange:output_type -> critic.v1.GetLastChangeResponse
	7,  // 30: critic.v1.CriticService.GetDiffSummary:output_type -> critic.v1.GetDiffSummaryResponse
	9,  // 31: critic.v1.CriticService.GetDiff:output_type -> critic.v1.GetDiffResponse
	18, // 32: critic.v1.CriticService.GetFile:output_type -> critic.v1.GetFileResponse
	20, // 33: critic.v1.CriticService.CreateComment:output_type -> critic.v1.CreateCommentResponse
	22, // 34: critic.v1.CriticService.GetComments:output_type -> critic.v1.GetCommentsResponse
	26, // 35: critic.v1.CriticService.GetDiffBases:output_type -> critic.v1.GetDiffBasesResponse
	28, // 36: critic.v1.CriticService.SetDiffBase:output_type -> critic.v1.SetDiffBaseResponse
