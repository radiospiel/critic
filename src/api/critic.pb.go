...
const file_critic_proto_rawDesc = "" +
	...
	"\tis_unread\x18\x06 \x01(\bR\bisUnread*\x97\x01\n" +
	"\tErrorCode\x12\x1a\n" +
	...
	"\x11LINE_TYPE_DELETED\x10\x032\xe0\x03\n" +
	"\rCriticService\x12R\n" +
	...
	"\vGetComments\x12\x1d.critic.v1.GetCommentsRequest\x1a\x1e.critic.v1.GetCommentsResponseB*Z(github.com/radiospiel/critic/src/api;apib\x06proto3"
...
var file_critic_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
...
var file_critic_proto_depIdxs = []int32{
	...
	4,  // 19: critic.v1.CriticService.GetLastChange:input_type -> critic.v1.GetLastChangeRequest
	6,  // 20: critic.v1.CriticService.GetDiffSummary:input_type -> critic.v1.GetDiffSummaryRequest
	8,  // 21: critic.v1.CriticService.GetDiff:input_type -> critic.v1.GetDiffRequest
	17, // 22: critic.v1.CriticService.GetFile:input_type -> critic.v1.GetFileRequest
	19, // 23: critic.v1.CriticService.CreateComment:input_type -> critic.v1.CreateCommentRequest
	21, // 24: critic.v1.CriticService.GetComments:input_type -> critic.v1.GetCommentsRequest
	5,  // 25: critic.v1.CriticService.GetLastChange:output_type -> critic.v1.GetLastChangeResponse
	7,  // 26: critic.v1.CriticService.GetDiffSummary:output_type -> critic.v1.GetDiffSummaryResponse
	9,  // 27: critic.v1.CriticService.GetDiff:output_type -> critic.v1.GetDiffResponse
	18, // 28: critic.v1.CriticService.GetFile:output_type -> critic.v1.GetFileResponse
	20, // 29: critic.v1.CriticService.CreateComment:output_type -> critic.v1.CreateCommentResponse
	22, // 30: critic.v1.CriticService.GetComments:output_type -> critic.v1.GetCommentsResponse
