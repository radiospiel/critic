...
const (
	...
	ConversationStatus_CONVERSATION_STATUS_INFORMAL             ConversationStatus = 5
	ConversationStatus_CONVERSATION_STATUS_ARCHIVED             ConversationStatus = 6
)
...
var (
	ConversationStatus_name = map[int32]string{
		...
		5: "CONVERSATION_STATUS_INFORMAL",
		6: "CONVERSATION_STATUS_ARCHIVED",
	}
...
const (
	ConversationType_CONVERSATION_TYPE_INVALID      ConversationType = 0
	ConversationType_CONVERSATION_TYPE_CONVERSATION ConversationType = 1
	ConversationType_CONVERSATION_TYPE_EXPLANATION  ConversationType = 2
)

// Enum value maps for ConversationType.
var (
	ConversationType_name = map[int32]string{
		0: "CONVERSATION_TYPE_INVALID",
		1: "CONVERSATION_TYPE_CONVERSATION",
		2: "CONVERSATION_TYPE_EXPLANATION",
	}
...
func (ConversationType) Descriptor() protoreflect.EnumDescriptor {
	return file_critic_proto_enumTypes[4].Descriptor()
}

func (ConversationType) Type() protoreflect.EnumType {
	return &file_critic_proto_enumTypes[4]
}
...
type GetConversationsRequest struct {
	...
	Statuses      []ConversationStatus `protobuf:"varint,2,rep,packed,name=statuses,proto3,enum=critic.v1.ConversationStatus" json:"statuses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetConversationsRequest) GetPaths() []string {
	if x != nil {
		return x.Paths
	}
	return nil
...
func (x *GetConversationsRequest) GetStatuses() []ConversationStatus {
	if x != nil {
		return x.Statuses
	}
	return nil
...
type FileConversationSummary struct {
	...
	ExplanationCount int32 `protobuf:"varint,6,opt,name=explanation_count,json=explanationCount,proto3" json:"explanation_count,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *FileConversationSummary) GetExplanationCount() int32 {
	if x != nil {
		return x.ExplanationCount
	}
	return 0
}
...
type Conversation struct {
	...
	ConversationType ConversationType `protobuf:"varint,10,opt,name=conversation_type,json=conversationType,proto3,enum=critic.v1.ConversationType" json:"conversation_type,omitempty"`
...
func (x *Conversation) GetConversationType() ConversationType {
	...
	return ConversationType_CONVERSATION_TYPE_INVALID
}

func (x *Conversation) GetBranchName() string {
	if x != nil {
		return x.BranchName
	}
	return ""
...
type GetDiffBasesResponse struct {
	...
	CurrentStart string `protobuf:"bytes,3,opt,name=current_start,json=currentStart,proto3" json:"current_start,omitempty"`
	// current_end is the end of the selected diff range (empty means working directory).
	CurrentEnd string `protobuf:"bytes,4,opt,name=current_end,json=currentEnd,proto3" json:"current_end,omitempty"`
	// error contains error details if the request failed.
	Error         *RpcError `protobuf:"bytes,15,opt,name=error,proto3" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetDiffBasesResponse) GetCurrentStart() string {
	if x != nil {
...
func (x *GetDiffBasesResponse) GetCurrentEnd() string {
	if x != nil {
		return x.CurrentEnd
	}
	return ""
...
func (x *SetDiffBaseRequest) GetStart() string {
	if x != nil {
		return x.Start
	}
	return ""
...
func (x *SetDiffBaseRequest) GetEnd() string {
	if x != nil {
		return x.End
	}
	return ""
...
type MarkConversationAsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MarkConversationAsRequest) Reset() {
	*x = MarkConversationAsRequest{}
	mi := &file_critic_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MarkConversationAsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MarkConversationAsRequest) ProtoMessage() {}

func (x *MarkConversationAsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_critic_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MarkConversationAsRequest.ProtoReflect.Descriptor instead.
func (*MarkConversationAsRequest) Descriptor() ([]byte, []int) {
	return file_critic_proto_rawDescGZIP(), []int{31}
}

func (x *MarkConversationAsRequest) GetConversationId() string {
	if x != nil {
		return x.ConversationId
	}
	return ""
...
func (x *MarkConversationAsRequest) GetStatus() ConversationStatus {
	if x != nil {
		return x.Status
	}
	return ConversationStatus_CONVERSATION_STATUS_INVALID
...
type MarkConversationAsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// error contains error details if the request failed.
	Error         *RpcError `protobuf:"bytes,15,opt,name=error,proto3" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *MarkConversationAsResponse) Reset() {
	*x = MarkConversationAsResponse{}
	mi := &file_critic_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MarkConversationAsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MarkConversationAsResponse) ProtoMessage() {}

func (x *MarkConversationAsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_critic_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MarkConversationAsResponse.ProtoReflect.Descriptor instead.
func (*MarkConversationAsResponse) Descriptor() ([]byte, []int) {
	return file_critic_proto_rawDescGZIP(), []int{32}
}

func (x *MarkConversationAsResponse) GetError() *RpcError {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *GetConfigResponse) GetDevMode() bool {
	if x != nil {
		return x.DevMode
	}
	return false
...
func (x *GetProjectConfigRequest) Reset() {
	*x = GetProjectConfigRequest{}
	mi := &file_critic_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetProjectConfigRequest) Descriptor() ([]byte, []int) {
	return file_critic_proto_rawDescGZIP(), []int{39}
}
...
type GetProjectConfigResponse struct {
	...
	Categories []*FileCategory `protobuf:"bytes,2,rep,name=categories,proto3" json:"categories,omitempty"`
	// editor contains editor integration settings.
	Editor *EditorConfig `protobuf:"bytes,3,opt,name=editor,proto3" json:"editor,omitempty"`
	// error contains error details if the request failed.
	Error         *RpcError `protobuf:"bytes,15,opt,name=error,proto3" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetProjectConfigResponse) Reset() {
	*x = GetProjectConfigResponse{}
	mi := &file_critic_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetProjectConfigResponse) Descriptor() ([]byte, []int) {
	return file_critic_proto_rawDescGZIP(), []int{40}
}

func (x *GetProjectConfigResponse) GetProjectName() string {
	if x != nil {
...
func (x *GetProjectConfigResponse) GetCategories() []*FileCategory {
	if x != nil {
		return x.Categories
	}
	return nil
...
func (x *GetProjectConfigResponse) GetEditor() *EditorConfig {
	if x != nil {
		return x.Editor
	}
	return nil
...
func (x *GetProjectConfigResponse) GetError() *RpcError {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *FileCategory) Reset() {
	*x = FileCategory{}
	mi := &file_critic_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FileCategory) Descriptor() ([]byte, []int) {
	return file_critic_proto_rawDescGZIP(), []int{41}
}

func (x *FileCategory) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *FileCategory) GetPatterns() []string {
	if x != nil {
		return x.Patterns
	}
	return nil
...
func (x *EditorConfig) Reset() {
	*x = EditorConfig{}
	mi := &file_critic_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EditorConfig) Descriptor() ([]byte, []int) {
	return file_critic_proto_rawDescGZIP(), []int{42}
}

func (x *EditorConfig) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *CreateExplanationRequest) Reset() {
	*x = CreateExplanationRequest{}
	mi := &file_critic_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateExplanationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateExplanationRequest) ProtoMessage() {}

func (x *CreateExplanationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_critic_proto_msgTypes[43]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateExplanationRequest.ProtoReflect.Descriptor instead.
func (*CreateExplanationRequest) Descriptor() ([]byte, []int) {
	return file_critic_proto_rawDescGZIP(), []int{43}
}

func (x *CreateExplanationRequest) GetFile() string {
	if x != nil {
		return x.File
	}
	return ""
...
func (x *CreateExplanationRequest) GetLine() int32 {
	if x != nil {
		return x.Line
	}
	return 0
...
func (x *CreateExplanationRequest) GetComment() string {
	if x != nil {
		return x.Comment
	}
	return ""
...
type CreateExplanationResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *CreateExplanationResponse) Reset() {
	*x = CreateExplanationResponse{}
	mi := &file_critic_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateExplanationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateExplanationResponse) ProtoMessage() {}

func (x *CreateExplanationResponse) ProtoReflect() protoreflect.Message {
	mi := &file_critic_proto_msgTypes[44]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateExplanationResponse.ProtoReflect.Descriptor instead.
func (*CreateExplanationResponse) Descriptor() ([]byte, []int) {
	return file_critic_proto_rawDescGZIP(), []int{44}
}

func (x *CreateExplanationResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *CreateExplanationResponse) GetError() *RpcError {
	if x != nil {
		return x.Error
	}
	return nil
...
const file_critic_proto_rawDesc = "" +
	...
	"\x05error\x18\x0f \x01(\v2\x13.critic.v1.RpcErrorR\x05error\"j\n" +
	"\x17GetConversationsRequest\x12\x14\n" +
	"\x05paths\x18\x01 \x03(\tR\x05paths\x129\n" +
	"\bstatuses\x18\x02 \x03(\x0e2\x1d.critic.v1.ConversationStatusR\bstatuses\"\x84\x01\n" +
	...
	"\x05error\x18\x0f \x01(\v2\x13.critic.v1.RpcErrorR\x05error\"\x8b\x02\n" +
	...
	"\x16has_unread_ai_messages\x18\x05 \x01(\bR\x13hasUnreadAiMessages\x12+\n" +
	"\x11explanation_count\x18\x06 \x01(\x05R\x10explanationCount\"\xa9\x03\n" +
	...
	"\n" +
	"updated_at\x18\t \x01(\tR\tupdatedAt\x12H\n" +
	"\x11conversation_type\x18\n" +
	" \x01(\x0e2\x1b.critic.v1.ConversationTypeR\x10conversationType\x12\x1f\n" +
	...
	"\x13GetDiffBasesRequest\"\xc0\x01\n" +
	"\x14GetDiffBasesResponse\x12\x14\n" +
	"\x05bases\x18\x01 \x03(\tR\x05bases\x12!\n" +
	"\fcurrent_base\x18\x02 \x01(\tR\vcurrentBase\x12#\n" +
	"\rcurrent_start\x18\x03 \x01(\tR\fcurrentStart\x12\x1f\n" +
	"\vcurrent_end\x18\x04 \x01(\tR\n" +
	"currentEnd\x12)\n" +
	"\x05error\x18\x0f \x01(\v2\x13.critic.v1.RpcErrorR\x05error\"P\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12)\n" +
	"\x05error\x18\x0f \x01(\v2\x13.critic.v1.RpcErrorR\x05error\"{\n" +
	"\x19MarkConversationAsRequest\x12'\n" +
	"\x0fconversation_id\x18\x01 \x01(\tR\x0econversationId\x125\n" +
	"\x06status\x18\x02 \x01(\x0e2\x1d.critic.v1.ConversationStatusR\x06status\"G\n" +
	"\x1aMarkConversationAsResponse\x12)\n" +
	"\x05error\x18\x0f \x01(\v2\x13.critic.v1.RpcErrorR\x05error\"&\n" +
	...
	"\fproject_name\x18\x01 \x01(\tR\vprojectName\x127\n" +
	"\n" +
	...
	"\x11LINE_TYPE_DELETED\x10\x03*\x8d\x02\n" +
	...
	"(CONVERSATION_STATUS_WAITING_FOR_RESPONSE\x10\x04\x12 \n" +
	"\x1cCONVERSATION_STATUS_INFORMAL\x10\x05\x12 \n" +
	"\x1cCONVERSATION_STATUS_ARCHIVED\x10\x06*x\n" +
	...
	"\x13ReplyToConversation\x12%.critic.v1.ReplyToConversationRequest\x1a&.critic.v1.ReplyToConversationResponse\x12a\n" +
	"\x12MarkConversationAs\x12$.critic.v1.MarkConversationAsRequest\x1a%.critic.v1.MarkConversationAsResponse\x12O\n" +
...
var file_critic_proto_goTypes = []any{
	...
	(ConversationType)(0),                   // 4: critic.v1.ConversationType
	(*RpcError)(nil),                        // 5: critic.v1.RpcError
	(*GetLastChangeRequest)(nil),            // 6: critic.v1.GetLastChangeRequest
	(*GetLastChangeResponse)(nil),           // 7: critic.v1.GetLastChangeResponse
	(*GetDiffSummaryRequest)(nil),           // 8: critic.v1.GetDiffSummaryRequest
	(*GetDiffSummaryResponse)(nil),          // 9: critic.v1.GetDiffSummaryResponse
	(*GetDiffRequest)(nil),                  // 10: critic.v1.GetDiffRequest
	(*GetDiffResponse)(nil),                 // 11: critic.v1.GetDiffResponse
	(*DiffSummary)(nil),                     // 12: critic.v1.DiffSummary
	(*FileSummary)(nil),                     // 13: critic.v1.FileSummary
	(*Diff)(nil),                            // 14: critic.v1.Diff
	(*FileDiff)(nil),                        // 15: critic.v1.FileDiff
	(*Hunk)(nil),                            // 16: critic.v1.Hunk
	(*HunkStats)(nil),                       // 17: critic.v1.HunkStats
	(*Line)(nil),                            // 18: critic.v1.Line
	(*GetFileRequest)(nil),                  // 19: critic.v1.GetFileRequest
	(*GetFileResponse)(nil),                 // 20: critic.v1.GetFileResponse
	(*CreateConversationRequest)(nil),       // 21: critic.v1.CreateConversationRequest
	(*CreateConversationResponse)(nil),      // 22: critic.v1.CreateConversationResponse
	(*GetConversationsRequest)(nil),         // 23: critic.v1.GetConversationsRequest
	(*GetConversationsResponse)(nil),        // 24: critic.v1.GetConversationsResponse
	(*GetConversationsSummaryRequest)(nil),  // 25: critic.v1.GetConversationsSummaryRequest
	(*GetConversationsSummaryResponse)(nil), // 26: critic.v1.GetConversationsSummaryResponse
	(*FileConversationSummary)(nil),         // 27: critic.v1.FileConversationSummary
	(*Conversation)(nil),                    // 28: critic.v1.Conversation
	(*Message)(nil),                         // 29: critic.v1.Message
	(*GetDiffBasesRequest)(nil),             // 30: critic.v1.GetDiffBasesRequest
	(*GetDiffBasesResponse)(nil),            // 31: critic.v1.GetDiffBasesResponse
	(*SetDiffBaseRequest)(nil),              // 32: critic.v1.SetDiffBaseRequest
	(*SetDiffBaseResponse)(nil),             // 33: critic.v1.SetDiffBaseResponse
	(*ReplyToConversationRequest)(nil),      // 34: critic.v1.ReplyToConversationRequest
	(*ReplyToConversationResponse)(nil),     // 35: critic.v1.ReplyToConversationResponse
	(*MarkConversationAsRequest)(nil),       // 36: critic.v1.MarkConversationAsRequest
	(*MarkConversationAsResponse)(nil),      // 37: critic.v1.MarkConversationAsResponse
	(*WatchFileRequest)(nil),                // 38: critic.v1.WatchFileRequest
	(*WatchFileResponse)(nil),               // 39: critic.v1.WatchFileResponse
	(*GetRootConversationRequest)(nil),      // 40: critic.v1.GetRootConversationRequest
	(*GetRootConversationResponse)(nil),     // 41: critic.v1.GetRootConversationResponse
	(*GetConfigRequest)(nil),                // 42: critic.v1.GetConfigRequest
	(*GetConfigResponse)(nil),               // 43: critic.v1.GetConfigResponse
	(*GetProjectConfigRequest)(nil),         // 44: critic.v1.GetProjectConfigRequest
	(*GetProjectConfigResponse)(nil),        // 45: critic.v1.GetProjectConfigResponse
	(*FileCategory)(nil),                    // 46: critic.v1.FileCategory
...
var file_critic_proto_depIdxs = []int32{
	...
	5,  // 1: critic.v1.GetLastChangeResponse.error:type_name -> critic.v1.RpcError
	12, // 2: critic.v1.GetDiffSummaryResponse.diff:type_name -> critic.v1.DiffSummary
	5,  // 3: critic.v1.GetDiffSummaryResponse.error:type_name -> critic.v1.RpcError
	15, // 4: critic.v1.GetDiffResponse.file:type_name -> critic.v1.FileDiff
	5,  // 5: critic.v1.GetDiffResponse.error:type_name -> critic.v1.RpcError
	13, // 6: critic.v1.DiffSummary.files:type_name -> critic.v1.FileSummary
	1,  // 7: critic.v1.FileSummary.status:type_name -> critic.v1.FileStatus
	15, // 8: critic.v1.Diff.files:type_name -> critic.v1.FileDiff
	1,  // 9: critic.v1.FileDiff.status:type_name -> critic.v1.FileStatus
	16, // 10: critic.v1.FileDiff.hunks:type_name -> critic.v1.Hunk
	18, // 11: critic.v1.Hunk.lines:type_name -> critic.v1.Line
	17, // 12: critic.v1.Hunk.stats:type_name -> critic.v1.HunkStats
	2,  // 13: critic.v1.Line.type:type_name -> critic.v1.LineType
	5,  // 14: critic.v1.GetFileResponse.error:type_name -> critic.v1.RpcError
	5,  // 15: critic.v1.CreateConversationResponse.error:type_name -> critic.v1.RpcError
	3,  // 16: critic.v1.GetConversationsRequest.statuses:type_name -> critic.v1.ConversationStatus
	28, // 17: critic.v1.GetConversationsResponse.conversations:type_name -> critic.v1.Conversation
	5,  // 18: critic.v1.GetConversationsResponse.error:type_name -> critic.v1.RpcError
	27, // 19: critic.v1.GetConversationsSummaryResponse.summaries:type_name -> critic.v1.FileConversationSummary
	5,  // 20: critic.v1.GetConversationsSummaryResponse.error:type_name -> critic.v1.RpcError
	3,  // 21: critic.v1.Conversation.status:type_name -> critic.v1.ConversationStatus
	29, // 22: critic.v1.Conversation.messages:type_name -> critic.v1.Message
	4,  // 23: critic.v1.Conversation.conversation_type:type_name -> critic.v1.ConversationType
	5,  // 24: critic.v1.GetDiffBasesResponse.error:type_name -> critic.v1.RpcError
	5,  // 25: critic.v1.SetDiffBaseResponse.error:type_name -> critic.v1.RpcError
	5,  // 26: critic.v1.ReplyToConversationResponse.error:type_name -> critic.v1.RpcError
	3,  // 27: critic.v1.MarkConversationAsRequest.status:type_name -> critic.v1.ConversationStatus
	5,  // 28: critic.v1.MarkConversationAsResponse.error:type_name -> critic.v1.RpcError
	5,  // 29: critic.v1.WatchFileResponse.error:type_name -> critic.v1.RpcError
	28, // 30: critic.v1.GetRootConversationResponse.conversation:type_name -> critic.v1.Conversation
	5,  // 31: critic.v1.GetRootConversationResponse.error:type_name -> critic.v1.RpcError
	5,  // 32: critic.v1.GetConfigResponse.error:type_name -> critic.v1.RpcError
	46, // 33: critic.v1.GetProjectConfigResponse.categories:type_name -> critic.v1.FileCategory
	47, // 34: critic.v1.GetProjectConfigResponse.editor:type_name -> critic.v1.EditorConfig
	5,  // 35: critic.v1.GetProjectConfigResponse.error:type_name -> critic.v1.RpcError
	5,  // 36: critic.v1.CreateExplanationResponse.error:type_name -> critic.v1.RpcError
	6,  // 37: critic.v1.CriticService.GetLastChange:input_type -> critic.v1.GetLastChangeRequest
	8,  // 38: critic.v1.CriticService.GetDiffSummary:input_type -> critic.v1.GetDiffSummaryRequest
	10, // 39: critic.v1.CriticService.GetDiff:input_type -> critic.v1.GetDiffRequest
	19, // 40: critic.v1.CriticService.GetFile:input_type -> critic.v1.GetFileRequest
	21, // 41: critic.v1.CriticService.CreateConversation:input_type -> critic.v1.CreateConversationRequest
	23, // 42: critic.v1.CriticService.GetConversations:input_type -> critic.v1.GetConversationsRequest
	25, // 43: critic.v1.CriticService.GetConversationsSummary:input_type -> critic.v1.GetConversationsSummaryRequest
	34, // 44: critic.v1.CriticService.ReplyToConversation:input_type -> critic.v1.ReplyToConversationRequest
	36, // 45: critic.v1.CriticService.MarkConversationAs:input_type -> critic.v1.MarkConversationAsRequest
	30, // 46: critic.v1.CriticService.GetDiffBases:input_type -> critic.v1.GetDiffBasesRequest
	32, // 47: critic.v1.CriticService.SetDiffBase:input_type -> critic.v1.SetDiffBaseRequest
	38, // 48: critic.v1.CriticService.WatchFile:input_type -> critic.v1.WatchFileRequest
	42, // 49: critic.v1.CriticService.GetConfig:input_type -> critic.v1.GetConfigRequest
	40, // 50: critic.v1.CriticService.GetRootConversation:input_type -> critic.v1.GetRootConversationRequest
	44, // 51: critic.v1.CriticService.GetProjectConfig:input_type -> critic.v1.GetProjectConfigRequest
	48, // 52: critic.v1.CriticService.CreateExplanation:input_type -> critic.v1.CreateExplanationRequest
	7,  // 53: critic.v1.CriticService.GetLastChange:output_type -> critic.v1.GetLastChangeResponse
	9,  // 54: critic.v1.CriticService.GetDiffSummary:output_type -> critic.v1.GetDiffSummaryResponse
	11, // 55: critic.v1.CriticService.GetDiff:output_type -> critic.v1.GetDiffResponse
	20, // 56: critic.v1.CriticService.GetFile:output_type -> critic.v1.GetFileResponse
	22, // 57: critic.v1.CriticService.CreateConversation:output_type -> critic.v1.CreateConversationResponse
	24, // 58: critic.v1.CriticService.GetConversations:output_type -> critic.v1.GetConversationsResponse
	26, // 59: critic.v1.CriticService.GetConversationsSummary:output_type -> critic.v1.GetConversationsSummaryResponse
	35, // 60: critic.v1.CriticService.ReplyToConversation:output_type -> critic.v1.ReplyToConversationResponse
	37, // 61: critic.v1.CriticService.MarkConversationAs:output_type -> critic.v1.MarkConversationAsResponse
	31, // 62: critic.v1.CriticService.GetDiffBases:output_type -> critic.v1.GetDiffBasesResponse
	33, // 63: critic.v1.CriticService.SetDiffBase:output_type -> critic.v1.SetDiffBaseResponse
	39, // 64: critic.v1.CriticService.WatchFile:output_type -> critic.v1.WatchFileResponse
	43, // 65: critic.v1.CriticService.GetConfig:output_type -> critic.v1.GetConfigResponse
	41, // 66: critic.v1.CriticService.GetRootConversation:output_type -> critic.v1.GetRootConversationResponse
	45, // 67: critic.v1.CriticService.GetProjectConfig:output_type -> critic.v1.GetProjectConfigResponse
	49, // 68: critic.v1.CriticService.CreateExplanation:output_type -> critic.v1.CreateExplanationResponse
