...
func (x *FileSummary) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *FileDiff) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
type CreateConversationRequest struct {
	...
	ConversationType ConversationType `protobuf:"varint,6,opt,name=conversation_type,json=conversationType,proto3,enum=critic.v1.ConversationType" json:"conversation_type,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CreateConversationRequest) GetConversationType() ConversationType {
	if x != nil {
...
func (x *FileConversationSummary) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *Conversation) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
const file_critic_proto_rawDesc = "" +
	...
	"\vDiffSummary\x12,\n" +
	"\x05files\x18\x01 \x03(\v2\x16.critic.v1.FileSummaryR\x05files\"\xf3\x01\n" +
	...
	"\tis_binary\x18\x06 \x01(\bR\bisBinary\x12\x1a\n" +
	"\bcategory\x18\a \x01(\tR\bcategory\"1\n" +
	"\x04Diff\x12)\n" +
	"\x05files\x18\x01 \x03(\v2\x13.critic.v1.FileDiffR\x05files\"\x97\x02\n" +
	"\bFileDiff\x12\x19\n" +
	"\bold_path\x18\x01 \x01(\tR\aoldPath\x12\x19\n" +
	"\bnew_path\x18\x02 \x01(\tR\anewPath\x12\"\n" +
	"\rfile_mode_old\x18\x03 \x01(\tR\vfileModeOld\x12\"\n" +
	...
	"\x05hunks\x18\a \x03(\v2\x0f.critic.v1.HunkR\x05hunks\x12\x1a\n" +
	"\bcategory\x18\b \x01(\tR\bcategory\"\xe5\x01\n" +
	"\x04Hunk\x12\x1b\n" +
	...
	"\x05error\x18\x0f \x01(\v2\x13.critic.v1.RpcErrorR\x05error\"\xeb\x01\n" +
	...
	"\acomment\x18\x05 \x01(\tR\acomment\x12H\n" +
	"\x11conversation_type\x18\x06 \x01(\x0e2\x1b.critic.v1.ConversationTypeR\x10conversationType\"a\n" +
	...
	"\x05error\x18\x0f \x01(\v2\x13.critic.v1.RpcErrorR\x05error\"\xa7\x02\n" +
	...
	"\x11explanation_count\x18\x06 \x01(\x05R\x10explanationCount\x12\x1a\n" +
	"\bcategory\x18\a \x01(\tR\bcategory\"\xc5\x03\n" +
	...
	"branchName\x12\x1a\n" +
	"\bcategory\x18\f \x01(\tR\bcategory\"\xa6\x01\n" +
	"\aMessage\x12\x0e\n" +
...
var file_critic_proto_depIdxs = []int32{
	...
	4,  // 15: critic.v1.CreateConversationRequest.conversation_type:type_name -> critic.v1.ConversationType
	5,  // 16: critic.v1.CreateConversationResponse.error:type_name -> critic.v1.RpcError
	3,  // 17: critic.v1.GetConversationsRequest.statuses:type_name -> critic.v1.ConversationStatus
	28, // 18: critic.v1.GetConversationsResponse.conversations:type_name -> critic.v1.Conversation
	5,  // 19: critic.v1.GetConversationsResponse.error:type_name -> critic.v1.RpcError
	27, // 20: critic.v1.GetConversationsSummaryResponse.summaries:type_name -> critic.v1.FileConversationSummary
	5,  // 21: critic.v1.GetConversationsSummaryResponse.error:type_name -> critic.v1.RpcError
	3,  // 22: critic.v1.Conversation.status:type_name -> critic.v1.ConversationStatus
	29, // 23: critic.v1.Conversation.messages:type_name -> critic.v1.Message
	4,  // 24: critic.v1.Conversation.conversation_type:type_name -> critic.v1.ConversationType
	5,  // 25: critic.v1.GetDiffBasesResponse.error:type_name -> critic.v1.RpcError
	5,  // 26: critic.v1.SetDiffBaseResponse.error:type_name -> critic.v1.RpcError
	5,  // 27: critic.v1.ReplyToConversationResponse.error:type_name -> critic.v1.RpcError
	3,  // 28: critic.v1.MarkConversationAsRequest.status:type_name -> critic.v1.ConversationStatus
	5,  // 29: critic.v1.MarkConversationAsResponse.error:type_name -> critic.v1.RpcError
	5,  // 30: critic.v1.WatchFileResponse.error:type_name -> critic.v1.RpcError
	28, // 31: critic.v1.GetRootConversationResponse.conversation:type_name -> critic.v1.Conversation
	5,  // 32: critic.v1.GetRootConversationResponse.error:type_name -> critic.v1.RpcError
	5,  // 33: critic.v1.GetConfigResponse.error:type_name -> critic.v1.RpcError
	46, // 34: critic.v1.GetProjectConfigResponse.categories:type_name -> critic.v1.FileCategory
